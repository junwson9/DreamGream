    ...
    return (
        <div>
            ...
            <div className="text-3xl font-medium leading-10 pl-[21px] pt-[17px]">
                ...
                <div className="text-zinc-500 text-left text-xs font-regular leading-none pl-[21px] pt-[17px]" 
                style={{color:'#888888'}}>
            ...
            <div className="pl-[21px] mt-[48px] w-72 h-10 text-stone-300 text-xs font-normal leading-none">🙏 멋진 그림 생성을 위해 줄임말이나 모호한 언어는 피해주세요!</div>
        </div>
    );
};
